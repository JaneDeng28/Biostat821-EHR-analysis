...
class Patient():
    global patients
    patients = parse_data('/Users/jane/2022/SP2022/BIOSTAT821/ehr-project/PatientCorePopulatedTable.txt')

    def __init__(self, patientID):
        PATDB = sqlite3.connect('/Users/jane/2022/SP2022/BIOSTAT821/ehr-project/patient.db')
        cursor = PATDB.cursor()
        ...
        cursor.execute("SELECT * FROM PATIENT INDEXED BY idx_id WHERE PATID=?", (patientID,))
...
class Observation():
    global labs
    labs = parse_data('/Users/jane/2022/SP2022/BIOSTAT821/ehr-project/LabsCorePopulatedTable.txt')
    ...
    def __init__(self, patientID):
        ...
        cursor.execute("SELECT * FROM LAB INDEXED BY idx_id WHERE PATID = ?", (patientID,))
        rows = cursor.fetchall()
        for row in rows:
            print(row)
